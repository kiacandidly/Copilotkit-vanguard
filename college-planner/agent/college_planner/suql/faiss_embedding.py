...
from college_planner.suql.postgresql_connection import execute_sql
from college_planner.suql.utils import chunk_text
...
if __name__ == "__main__":
    ...
    embedding_store.add(
        table_name="schools",
        primary_key_field_name="school_id",
        free_text_field_name="weather",
        db_name="college_planning",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="schools",
        primary_key_field_name="school_id",
        free_text_field_name="reviews_text",
        db_name="college_planning",
        user="select_user",
        password="select_user",
    )
