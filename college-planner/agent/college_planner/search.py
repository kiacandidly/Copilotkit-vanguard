...
from college_planner.state import AgentState, College

@tool
def search_for_places(queries: list[str]) -> list[dict]:
    """Search for colleges based on a query, returns a list of colleges including their name, address, and coordinates, and ratings with type signature of College class """
