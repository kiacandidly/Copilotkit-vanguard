...
from college_planner.trips import trips_node
from college_planner.chat import chat_node
from college_planner.search import search_node
from college_planner.trips import perform_trips_node
from college_planner.state import AgentState
from college_planner.suql_tool import college_search_node
    ...
    if messages and isinstance(messages[-1], AIMessage):
        ...
        if ai_message.tool_calls:
            ...
            if tool_name in ["search_for_places"]:
                return "search_node"
            if tool_name in ["search_for_colleges"]:
                return "college_search_node"
            return "chat_node"
...
graph_builder.add_node("college_search_node", college_search_node)

graph_builder.add_conditional_edges("chat_node", route, ["search_node", "college_search_node", "chat_node", "trips_node", END])

graph_builder.add_edge(START, "chat_node")
graph_builder.add_edge("search_node", "chat_node")
graph_builder.add_edge("college_search_node", "chat_node")
